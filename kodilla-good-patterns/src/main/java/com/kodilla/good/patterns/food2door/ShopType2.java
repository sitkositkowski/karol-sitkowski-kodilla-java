...
public class ShopType2 implements Shop {
    ...
    public ShopType2(String name, InformationService informationService, OrderRepository orderRepository) {
        this.name = name;
    ...
    @Override
    public void process() {
        final List<Order> temporaryOrders = new ArrayList<>();
        String isRealised;
